  ...
  return (
    <div className="privacy-policy container my-5">
      ...
      <header className="mb-5">
        <h1 className="mb-3 text-center">CineNiche Privacy Policy</h1>
      ...
      <section className="mb-5">
        <h2 className="mb-3 section-heading">1. Introduction</h2>
        <p>
      ...
      <section className="mb-5">
        <h2 className="mb-3 section-heading">2. Information We Collect</h2>
        ...
        <ul>
          <li><strong>Account Information:</strong> Your name, email address, password, and billing details.</li>
          <li><strong>Profile Information:</strong> Usernames, profile photos, and preferences.</li>
          <li><strong>Communication Information:</strong> Contact details if you choose to contact support or subscribe to communications (e.g., newsletters).</li>
        </ul>
        ...
        <ul>
          <li><strong>Usage Data:</strong> Information about your interactions—pages viewed, movie selections, and time spent on the platform.</li>
          <li><strong>Device Information:</strong> Details about your device including model, operating system, browser type, and IP address.</li>
          <li><strong>Cookies &amp; Tracking Technologies:</strong> We use cookies, pixels, and similar tools to gather this data (see Section 5 for details).</li>
        </ul>
        <h3 className="mt-4">2.3 Data from Third-Party Sources</h3>
        <p>
          ...
          to enhance your experience. This data is subject to the terms of those platforms.
        </p>
      </section>

      {/* Section 3: How We Use Your Information */}
      <section className="mb-5">
        <h2 className="mb-3 section-heading">3. How We Use Your Information</h2>
        <ul>
          <li>
          ...
          <li className="mt-3">
            ...
            <ul>
              ...
              <li>Send updates, promotions, or important account notices.</li>
            </ul>
          </li>
          <li className="mt-3">
          ...
          <li className="mt-3">
            ...
            <ul>
              <li>Conduct aggregate research to improve our services while keeping data anonymized.</li>
            </ul>
          </li>
        </ul>
      </section>
      ...
      <section className="mb-5">
        <h2 className="mb-3 section-heading">4. How We Share Your Information</h2>
        ...
        <h3 className="mt-4">4.2 In Response to Legal Requests</h3>
        <p>
        ...
        <h3 className="mt-4">4.3 Business Transfers</h3>
        <p>
        ...
        <h3 className="mt-4">4.4 Aggregated or Anonymized Data</h3>
        <p>
      ...
      <section className="mb-5">
        <h2 className="mb-3 section-heading">5. Cookies and Tracking Technologies</h2>
        ...
        <h3 className="mt-4">5.2 How We Use Cookies</h3>
        <ul>
          <li>Authenticate and maintain your session.</li>
          <li>Collect usage data to understand interactions with our Services.</li>
          <li>Customize content and provide personalized recommendations.</li>
        </ul>
        <h3 className="mt-4">5.3 Managing Cookies</h3>
        <p>
          You can manage your cookie preferences via your browser settings. Disabling cookies may affect some functionalities of our Services.
        </p>
      </section>

      {/* Section 6: Data Security */}
      <section className="mb-5">
        <h2 className="mb-3 section-heading">6. Data Security</h2>
        <p>
      ...
      <section className="mb-5">
        <h2 className="mb-3 section-heading">7. Data Retention</h2>
        <p>
      ...
      <section className="mb-5">
        <h2 className="mb-3 section-heading">8. Your Rights and Choices</h2>
        <p>
          Depending on your location and applicable laws, you may have certain rights regarding your Personal Information, including:
        </p>
        <ul>
          <li><strong>Access &amp; Correction:</strong> Request copies of your data or have inaccuracies corrected.</li>
          <li><strong>Deletion:</strong> Request deletion of your Personal Information, subject to limitations.</li>
          <li><strong>Objection &amp; Restriction:</strong> Object to or restrict the processing of your Personal Information.</li>
          <li><strong>Data Portability:</strong> Request that your information be transferred in a common format.</li>
        </ul>
        <p>
      ...
      <section className="mb-5">
        <h2 className="mb-3 section-heading">9. International Data Transfers</h2>
        <p>
          CineNiche operates globally and may transfer your Personal Information to countries outside your home jurisdiction.
          We ensure that appropriate safeguards are in place in accordance with applicable privacy laws.
        </p>
      </section>

      {/* Section 10: Children's Privacy */}
      <section className="mb-5">
        <h2 className="mb-3 section-heading">10. Children's Privacy</h2>
        <p>
          Our Services are not directed at children under the age of 13, and we do not knowingly collect Personal Information from them.
          If such data is inadvertently collected, we will promptly take steps to delete it.
        </p>
      </section>

      {/* Section 11: Changes to This Privacy Policy */}
      <section className="mb-5">
        <h2 className="mb-3 section-heading">11. Changes to This Privacy Policy</h2>
        <p>
          We regularly review and update this Privacy Policy. Material changes will be posted on our website along with an updated "Last Updated" date.
          Continued use of our Services signifies your acceptance of any changes.
        </p>
      </section>

      {/* Section 12: Contact Us */}
      <section className="mb-5">
        <h2 className="mb-3 section-heading">12. Contact Us</h2>
        <p>
        ...
        <address>
          ...
          <br /><br />
          For inquiries regarding data protection rights, please contact our Data Protection Officer at <a href="mailto:dpo@cineniche.com">dpo@cineniche.com</a>.
        </address>
      </section>
    </div>
  );
