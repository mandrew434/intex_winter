...
const genreOptions: GenreOption[] = [
  ...
  {
    value: 'documentariesInternationalMovies',
  ...
  {
    value: 'internationalMoviesThrillers',
    label: 'International Movies Thrillers',
  },
  {
    value: 'internationalTvShowsRomanticTvShowsTvDramas',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        'https://intex-winter-backend-had2hmbubbgfczd8.eastus-01.azurewebsites.net/api/Movie/AddMovie',
        {
          method: 'POST',
          headers: {
        ...
        <div className="row">
          <div className="col-md-6 mb-3">
            <label className="form-label">
              Duration (e.g., Number of Seasons)
            </label>
            <input
              type="text"
              className="form-control"
